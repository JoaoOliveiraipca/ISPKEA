...
from core.views import place_order, checkout_view, update_cart, delete_item_from_cart, cart_view, add_to_cart, add_review, index, product_list_view, product_detail_view, category_list_view,category_product_list_view
